        ...
        <section id='projects' className='w-screen bg-black text-white pr-10 pl-10 md:pr-32 md:pl-32 font-light text-[50px] pt-16 pb-16'>
            ...
            <div className='mt-16 flex flex-col gap-24'>
                <Project
                    ...
                    video={'https://i.imgur.com/bjjJZbC.png'}
                ...
                <Project
                    ...
                    video={'https://i.imgur.com/fCTaKBp.png'}
                    cursorEnter={cursorEnter}
                    cursorLeave={cursorLeave}
                />
                <Project
                    ...
                    video={'https://i.imgur.com/NxylhTv.png'}
                ...
                <Project
                    title='Playfolio'
                    description="Playfolio is... what you're taking a look at right now! Although it is not publicly available to look at, this website is supported by a custom CMS implemented for easy content management. I'm looking forward to seeing how this site will grow over the coming year."
                    github="https://github.com/alderwhiteford/Playfolio"
                    skills={['NextJS', 'TypeScript', 'HTML', 'CSS' ]}
                    video={'https://i.imgur.com/TaqsjHm.png'}
                    cursorEnter={cursorEnter}
                    cursorLeave={cursorLeave}
                />
                <Project
                    ...
                    additionalInfo="https://chalk-primula-2b3.notion.site/Final-Project-02105fd5e12a43ef90870fec2a43e5ea"
                    skills={['ReactJS', 'JavaScript', 'HTML', 'CSS', 'Scala', 'MongoDB', 'AWS' ]}
                    video={'https://i.imgur.com/ZmvIG4c.png'}
                    cursorEnter={cursorEnter}
                    cursorLeave={cursorLeave}
                />
                <Project
                    ...
                    video={'https://i.imgur.com/48Oc05e.png'}
                    cursorEnter={cursorEnter}
                    cursorLeave={cursorLeave}
                />
                <Project
                    ...
                    video={'https://i.imgur.com/xXhXoHa.png'}
                    cursorEnter={cursorEnter}
                    cursorLeave={cursorLeave}
                />
            </div>
